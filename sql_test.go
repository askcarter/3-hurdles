...
var tests = []struct {
	...
	{"Init DB from disk",
		func(t *testing.T, db DataSource) {
			...
			wantUsers := UserList{
				{Email: "alina@example.com", Name: "Alina", Password: "$2a$10$KgFhp4HAaBCRAYbFp5XYUOKrbO90yrpUQte4eyafk4Tu6mnZcNWiK"},
				{Email: "askcarter@example.com", Name: "Carter", Password: "$2a$10$KgFhp4HAaBCRAYbFp5XYUOKrbO90yrpUQte4eyafk4Tu6mnZcNWiK"},
			}
			...
			wantDecks := DeckList{
				{Name: "alina@example.com:spanish"},
				{Name: "askcarter@example.com:algebra"},
				{Name: "askcarter@example.com:programming"},
			}
			...
			wantCards := CardList{
				{Owner: "alina@example.com:spanish", Front: "feugo", Back: "pretty"},
				{Owner: "alina@example.com:spanish", Front: "futbol", Back: "soccer"},
				{Owner: "alina@example.com:spanish", Front: "que?", Back: "what?"},
				{Owner: "alina@example.com:spanish", Front: "a donde es?", Back: "where is?"},
				{Owner: "alina@example.com:spanish", Front: "hola", Back: "hello"},
				{Owner: "askcarter@example.com:algebra", Front: "x*0", Back: "0"},
				{Owner: "askcarter@example.com:algebra", Front: "x+0", Back: "x"},
				{Owner: "askcarter@example.com:algebra", Front: "x+x", Back: "2x"},
				{Owner: "askcarter@example.com:programming", Front: "favorite programming language", Back: "Go"},
				{Owner: "askcarter@example.com:programming", Front: "public interface", Back: "API"},
			}
